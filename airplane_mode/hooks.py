...
app_publisher = "Zain (Xeverse Planet)"
app_description = "A Frappe app to manage and simulate airplane mode features for users, including toggling network access, offline data management, and tracking system connectivity status in enterprise systems"
app_email = "zainjee331@gmail.com"
app_license = "mit"



web_page_context = {
    "airplane_flight": "airplane_flight.get_context",
    "flights": "airplane_flight_list.get_context",
     "airline": "airplane_mode.www.airline.get_context"
}
